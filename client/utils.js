...
function updateTranscription(transcript_data) {
    ...
    if (
        ...
        transcript_data["language_probability"]
    ) {
...
function sendAudioConfig() {
    let selectedStrategy = document.getElementById(
    ...
    if (selectedStrategy === "silence_at_end_of_chunk") {
        processingArgs = {
            chunk_length_seconds: parseFloat(
                document.getElementById("chunk_length_seconds").value
            ),
            chunk_offset_seconds: parseFloat(
...
function toggleBufferingStrategyPanel() {
    var selectedStrategy = document.getElementById(
        "bufferingStrategySelect"
    ).value;
    if (selectedStrategy === "silence_at_end_of_chunk") {
